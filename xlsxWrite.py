...
ws.append([csvvalues['name'],csvvalues['available_qty'],csvvalues['type'],csvvalues['profit_loss'],csvvalues['valuation_price'],csvvalues['purchase_value'],csvvalues['sell_value']])
...
for orders in csvvalues['purchase_order']:
        ...
        ws.append([orders,data['date'],data['name'],data['quantity'],data['price'],data['total_tax'],data['total_price'],data['unit_price']])
